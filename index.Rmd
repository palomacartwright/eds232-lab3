...
`r which.max(all_stats)` is the vegetation class is the most abundant. 
...
`r sum(repr_data$relative_held < 0.1)` fail to meet this target. **Ask friends about this one.**
...
There were 15 planning units selected which was `r 15/516`% of the total. 
